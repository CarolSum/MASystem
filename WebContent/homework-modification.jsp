...
<body>
  ...
  <div class="content-body">
    ...
    <div class="module-title">修改作业</div>
    <div class="dashboard">
      <div class="main-block">
        <div class="main-block-box">
          ...
          <div class="edit-area">
            <form class="form-horizontal" action="/MASystem/homework-modify" method="post">
              <div class="form-group">
                <label for="hw-title" class="col-sm-2 control-label">作业标题</label>
                <div class="col-sm-8">
                  <input type="text" class="form-control" id="hw-title" name= "hw-title" placeholder="请输入作业标题" value="${curHomework.title}" required>
                </div>
              </div>
              <div class="form-group">
                <label for="hw-start-time" class="col-sm-2 control-label">起始时间</label>
                <div class="col-sm-8">
                  <input type="text" class="form-control" id="hw-start-time" name="hw-start-time" placeholder="YYYY:MM:DD" value="${curHomework.startDate}" required>
                </div>
              </div>
              <div class="form-group">
                <label for="hw-end-time" class="col-sm-2 control-label">截止时间</label>
                <div class="col-sm-8">
                  <input type="text" class="form-control" id="hw-end-time" name="hw-end-time" placeholder="YYYY:MM:DD" value="${curHomework.endDate}" required>
                </div>
              </div>
              <div class="form-group">
                <label for="new-hw-content" class="col-sm-2 control-label">内容</label>
                <div class="col-sm-8">
                  <textarea class="form-control" rows="10" id="new-hw-content" name="new-hw-content" placeholder="请输入作业内容" required>${curHomework.content}</textarea>
                </div>
              </div>
